    ...
    <div className='main'>
        ...
        <p>How Can I Help You Today?</p>
            ...
            <div className='cards'>
                ...
                <div className='card'>
                <p>Improve the readbaility of the follwing code </p>
    ...
    :<div className='result'>
        ...
        :<p dangerouslySetInnerHTML={{__html:resultData}}></p>
                ...
                <div className='main-bottom'>
                    ...
                    Gemini may display inaccurate info, including about people, so double-check its responses. Your privacy & Gemini Apps </p>
                </div>
        </div>
   </div>
  )
